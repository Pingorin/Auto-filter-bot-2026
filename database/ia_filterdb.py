# database/ia_filterdb.py (Umongo 3.x Compatible - Final Fix)
import re
from motor.motor_asyncio import AsyncIOMotorClient
# Naye version mein set_motor_backend nahi chahiye
...
# MotorAsyncIOInstance backend ko apne aap set kar deta hai
...
class Media(Document):
    ...
    # Ab requirements update hone ke baad default="" sahi chalega
