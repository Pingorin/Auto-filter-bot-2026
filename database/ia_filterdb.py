...
# umongo 2.x ke liye set_motor_backend aur MotorAsyncIOInstance ko import karna zaroori hai
...
# ZAROORI: Umongo 2.x mein set_motor_backend call mandatory hai
...
class Media(Document):
    ...
    # Umongo 2.x ke liye default parameter yahan sahi hai
